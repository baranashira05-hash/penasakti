    ...
    <section className="bg-background">
      <div className="container mx-auto px-4 py-4 sm:py-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          {/* Main Slider — semua slide di-render sekaligus, transisi via CSS opacity/transform */}
            ...
            >
              {sliderArticles.map((article, index) => (
                <div
                  ...
                  style={{
                    ...
                    // Slide aktif di depan, lainnya di belakang
                    zIndex: index === currentSlide ? 1 : 0,
                    // Scale halus via CSS — tidak perlu framer-motion mount/unmount
              ...
              {sliderArticles.length > 1 && (
                <>
                  <button
                    onClick={prev}
                    className="absolute left-3 top-1/2 -translate-y-1/2 w-9 h-9 rounded-full bg-black/40 hover:bg-black/70 text-white flex items-center justify-center transition-colors backdrop-blur-sm z-10"
                  ...
                  <button
                    onClick={next}
                    className="absolute right-3 top-1/2 -translate-y-1/2 w-9 h-9 rounded-full bg-black/40 hover:bg-black/70 text-white flex items-center justify-center transition-colors backdrop-blur-sm z-10"
